...
def ejecucion():
    ...
    promedioPorAnios(file)
    variacionPrecioGas(file)
    promedioPorZona("2016-01-01", "2016-12-31", "2016", file)
    promedioPorZona("2017-01-01", "2017-12-31", "2017", file)
    mayorDelAnio("2016-01-01", "2016-12-31", "2016", file)
    mayorDelAnio("2017-01-01", "2017-12-31", "2017", file)
...
def promedioPorZona(fechaInicio, fechaFin, anio, file):
...
def mayorDelAnio(fechaInicio, fechaFin, anio, file):
